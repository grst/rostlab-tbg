...
protected:
    ...
    float fThreshold; // Distance of frame move before switch
...
public:
    ...
    static SlidingMenuGrid* menuWithArray(CCArray *items, int cols, int rows, CCPoint pos , CCPoint pad, bool vertical, float threshold);
    bool initWithArray(CCArray *items, int cols, int rows, CCPoint pos , CCPoint pad, bool vertical, float threshold);
