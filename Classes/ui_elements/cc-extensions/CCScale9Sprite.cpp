...
CCScale9Sprite::CCScale9Sprite(const char* file, const CCRect & centreRegion) {
	...
	centre = CCSprite::createWithTexture(scale9Image->getTexture() , centreRegion);

	scale9Image->addChild(centre , 0 ,pCentre);

	//top
	top = CCSprite::createWithTexture(scale9Image->getTexture(),CCRect(centreRegion.origin.x,
	 0,
	...
	//bottom
	bottom = CCSprite::createWithTexture(scale9Image->getTexture(),CCRect(centreRegion.origin.x,
	...
	//left
	left = CCSprite::createWithTexture(scale9Image->getTexture(),CCRect(0,
	 centreRegion.origin.y,
	...
	//right
	right = CCSprite::createWithTexture(scale9Image->getTexture(),CCRect(centreRegion.origin.x + centreRegion.size.width,
	 centreRegion.origin.y,
	...
	//top left
	topLeft = CCSprite::createWithTexture(scale9Image->getTexture(),CCRect(0,
	 0,
	 centreRegion.origin.x,
	 centreRegion.origin.y));
	...
	//top right
	topRight = CCSprite ::createWithTexture(scale9Image->getTexture(),CCRect(centreRegion.origin.x + centreRegion.size.width,
	 0,
	 imageSize.width - (centreRegion.origin.x + centreRegion.size.width),
	 centreRegion.origin.y));
	...
	//bottom left
	bottomLeft = CCSprite::createWithTexture(scale9Image->getTexture(),CCRect(0,
	 centreRegion.origin.y + centreRegion.size.height,
	 centreRegion.origin.x,
	 imageSize.height - (centreRegion.origin.y + centreRegion.size.height)));
	...
	//bottom right
	bottomRight = CCSprite ::createWithTexture(scale9Image->getTexture(),CCRect(centreRegion.origin.x + centreRegion.size.width,
	 centreRegion.origin.y + centreRegion.size.height,
	 imageSize.width - (centreRegion.origin.x + centreRegion.size.width),
	 imageSize.height - (centreRegion.origin.y + centreRegion.size.height))
	);
...
void CCScale9Sprite::setOpacity(GLubyte var)
{
	...
	if (scale9Image->getChildren() && scale9Image->getChildren()->count() != 0)
	{
		...
		CCARRAY_FOREACH(scale9Image->getChildren(), child)
		{
			...
			if (pNode)
			{
			//	CCRGBAProtocol *pRGBAProtocol = pNode->
			//	if (pRGBAProtocol)
			//	{
